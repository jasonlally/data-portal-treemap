...
for city in cities:
	#sURL = 'https://data.illinois.gov/belleville'
	if 'open_data_site_url' in city and 'url' in city['open_data_site_url']:
...
print json.dumps(final, sort_keys=False, indent=4, separators=(',', ': '))